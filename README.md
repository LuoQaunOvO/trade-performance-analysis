...
- 境外合规平台(加密资产/贵金属衍生品)实盘导出数据(2025-01 ~ 2026-08):成交明细 / 历史仓位 / 历史委托 / 资金流水
- 成交明细 2394 条,完整仓位 821 个,覆盖 BTC / ETH / SOL / XAU(黄金)/ XAG(白银)等主流资产
...
| 最新基差 | -7 元/吨 | 期货小幅升水 |
| 基差率 | -0.23% | 接近平水 |
| **基差率历史分位** | **近180日86%分位** | 基差已从年内低位(-4.14%)大幅修复,深度贴水阶段已过 |
| 库存 | 34417 | 近30日去库-15993(旺季去库) |
| 价格-库存相关性 | r=0.59 | 中等正相关,库存可作价格辅助判断 |
| **盘面利润** | +618 元/吨 | 处于偏高水平,钢厂增产动力强 |

**正套损益测算(含资金成本,年化4.5%)**:平水收敛情景30天持有净收益 -4.2 元/吨(不覆盖资金成本),
盈亏平衡基差 +4.2 元/吨;基差转升水 +20 元/吨时 30 天净收益 +15.8 元/吨——当前不是正套的性价比窗口。

**跟踪信号表**:以"基差分位 + 库存拐点 + 盘面利润"三维触发(正套观察/收敛止盈/正套风险/减产预期/增产压力),
当前 S2收敛止盈、S5增产压力已触发。

**研究结论**:去库延续支撑现货,但基差修复已部分定价该预期;研究价值在于**用量化测算排除"看起来像机会"的假机会**——
等待基差重新走弱(分位回落至30%以下)或盘面利润收缩后的再平衡机会。
